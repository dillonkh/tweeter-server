...
//        LoginRequest loginRequest = new LoginRequest("pass",user.getAlias());
//        LoginPresenter loginPresenter = new LoginPresenter();
//        LoginResponse loginResponse = loginPresenter.login(loginRequest);
//
//        Assertions.assertEquals(loginResponse.isAuthentcated(), false);
//        Assertions.assertEquals(loginResponse.getUserSignedIn(), null);
//
//    }
}
